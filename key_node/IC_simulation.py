...
def main():
    ...
    rep = pickle.load(open('/home/lab0/coinwar/key_node/updated_graph_with_for_critical_node.pkl',"rb"))  # 通过GAT变换后的图的节点向量表示
    ...
    # Exporting to GEXF
    nx.write_gexf(G, '/home/lab0/coinwar/key_edge/our_approach_predicted_critical_score.gexf')
